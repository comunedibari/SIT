...
from catalog.rndt import service_metadata, service_metadata_xml
    ...
    def write_record(self, result, esn, outputschema, queryables, caps=None):
        ...
        if esn in ['summary', 'full']:
            BaseUnit = et.SubElement(valueUnit, util.nspath_eval(
                'gml32:BaseUnit', self.namespaces), {'{http://www.opengis.net/gml/3.2}id': 'm'})
            et.SubElement(BaseUnit, util.nspath_eval(
                'gml32:identifier', self.namespaces), {'codeSpace': 'http://www.bipm.org/en/si/base_units'}).text = 'm'
            et.SubElement(BaseUnit, util.nspath_eval(
                'gml32:unitsSystem', self.namespaces))
        ...
        if esn in ['summary', 'full']:
            ...
            try:
                ...
                viewer = u"""
                <gmd:transferOptions xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco">
        ...
        metadataStandardVersion.getchildren()[0].text = '10 novembre 2011'
        metadataStandardName = node.xpath(
            '//gmd:metadataStandardName', namespaces=node.nsmap)[0]
        metadataStandardName.getchildren()[0].text = 'DM - Regole tecniche RNDT'
