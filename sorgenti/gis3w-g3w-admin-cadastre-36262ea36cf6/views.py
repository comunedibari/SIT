...
class SearchByCFView(View):
    ...
    def widget_search_cf_response(self, data_project, soggetti):
        """
    ...
    def get(self, request, *args, **kwargs):
        ...
        if search_by_ns:
            ...
            # ---------------------------------------------
            return self.widget_search_cf_response(data_project, soggetto)
            ...
            if particella not in particelle:
                ...
                try:
                    if search_endpoint == 'ows':
                        subq = '"foglio" = \'{}\' AND "{}" = \'{}\' AND "tipo" = \'F\''
                    else:
                        subq = 'foglio|eq|{}|and,{}|eq|{}|and,tipo|eq|F'
        ...
        for ii in particelle_terreno:
            ...
            if particella not in particelle:
                ...
                try:
                    if search_endpoint == 'ows':
                        subq = '"foglio" = \'{}\' AND "{}" = \'{}\' AND "tipo" = \'T\''
                        if ii.sezione:
                            subq += ' AND "sezione" = \'{}\''
                    else:
                        subq = 'foglio|eq|{}|and,{}|eq|{}|and,tipo|eq|T'
                        if ii.sezione:
                               subq += 'and|sezione|eq|{}'
                    query_c.append(subq.format(
                        ii.foglio.lstrip('0'),
