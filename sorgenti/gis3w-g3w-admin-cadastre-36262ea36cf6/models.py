...
class UnitaImmobiliare(models.Model):
    ...
    annotazione = models.CharField(blank=True, null=True, max_length=200)
...
class PersonaFisica(models.Model):
    ...
    id_soggetto = models.IntegerField(primary_key=True)
    codice_comune = models.CharField(blank=True, null=True, max_length=4)
    ...
    luogo_nascita = models.CharField('Luogo di nascita', blank=True, null=True, max_length=4)
...
class PersonaGiuridica(models.Model):
    ...
    sede = models.CharField(blank=True, null=True, max_length=4)
...
class Titolarita(models.Model):
    ...
    soggetto_riferimento = models.CharField('Soggetto di riferimento', blank=True, null=True, max_length=9)
    ...
    def set_permissions_to_editor_user_groups(self):
        ...
        if len(permissionEditorGroupToRemove):
            for pegr in permissionEditorGroupToRemove:
                setPermissionUserObject(pegr, self.progect, permissions=['edit_cadastre_association'],
                                        mode='remove')
