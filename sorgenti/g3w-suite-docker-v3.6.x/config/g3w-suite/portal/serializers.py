...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        feature['thumbnail'] = f"https://sit.egov.ba.it{feature['thumbnail']}"
...
class GroupSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        feature['header_logo_img'] = f"https://sit.egov.ba.it{feature['header_logo_img']}"
...
class MacroGroupSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        feature['logo_img'] = f"https://sit.egov.ba.it{feature['logo_img']}"
