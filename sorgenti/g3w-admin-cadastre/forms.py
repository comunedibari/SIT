...
class ConfigForm(G3WFormMixin, G3WRequestFormMixin, G3WACLForm, ModelForm):
    ...
    def clean_layers(self):
        ...
        for layer in layers:
            ...
            config_cxf = ConfigImportCxf.objects.filter(codice_comune=codice_comune)
            ...
            if len(config_cxf) > 0:
                ...
                if layer.origname != cadastre_layer_origname:
                    raise ValidationError(
                        _('Layer {} not correct, original table name must be {}'.format(layer.title,
                                                                                        cadastre_layer_origname)))
                                    ...
                                    Div(
                                        Div(
                                            ...
                                            Div(
                                                ...
                                                Field('transform', **{'data_icheck_skin': 'blue'}),
                                                'db_user',
                                                'db_password',
                                                css_class='box-body',
