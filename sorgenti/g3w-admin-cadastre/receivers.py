        ...
        if 'CF' in searches:
            for layer_id, queryurl, layer_title in layer_ids:
                ...
                data['values'].append({
                    ...
                    "name": f"Ricerca particelle catastali per CODICE FISCALE o PIVA sul layer {layer_title}",
                    "type": "search",
                    "options": {
        ...
        if 'NS' in searches:
            for layer_id, queryurl, layer_title in layer_ids:
                data['values'].append({
                    ...
                    "name": f"Ricerca particelle catastali per NOME e COGNOME sul layer {layer_title}",
                    "type": "search",
                    "options": {
                        "querylayerid": layer_id,
                        "queryurl": queryurl,
