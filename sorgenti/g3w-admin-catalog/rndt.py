...
def service_metadata_xml(catalog, base_url):
    ...
    _add('gco', 'CharacterString', {},
         '2.0', parent=metadataStandardVersion)
    ...
    #
    #
    # # Ci deve essere una sezione gmd:resourceConstraints
    # # con l'indicazione dei vincoli rispetto alla Direttiva INSPIRE.
    # # ==============================================================
    ...
    #     },
    #     text='otherRestrictions',  ## "%s" % _('Other restrictions'),
    ...
    #     'Anchor',
    #     {
    #         '{http://www.w3.org/1999/xlink}href': 'http://inspire.ec.europa.eu/metadata-codelist/LimitationsOnPublicAccess/noLimitations',
    #     },
    #     #text='Nessuna limitazione all\'accesso pubblico',  ## "%s" % _('Other restrictions'),
    #     text='Nessuna limitazione all\'accesso pubblico',  ## "%s" % _('Other restrictions'),
    ...
    # TODO: 16/03/22 to move to rndt_profile.rndt.rndt.py
