...
from cdu.utils.tdws import date_from_fc
...
class CDUTestUtils(QdjangoTestBase):
    ...
    def test_date_from_fc(self):
        """ Test def date_from_fc"""

        fc = 'lrnwtr74m22e715t'

        bd = date_from_fc(fc)

        self.assertEqual(bd.isoformat(), '1974-08-22T00:00:00')

        fc = 'lrnwtr18m22e715t'

        bd = date_from_fc(fc)

        self.assertEqual(bd.isoformat(), '2018-08-22T00:00:00')
